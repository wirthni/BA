...
where $\Delta_{ij}^2 = (y_i - y_j)^2 + (\phi_i - \phi_j)^2$ and $k_{ti}, y_i \text{ and } \phi_i$ are the transverse momentum, papidity and azimuth of particle $i$ respectively. The quantity $d_{iB}$ is called beam distance of particle $i$. $R$ is the jet radius parameter.
